...
//	dateStr格式为yyyy-MM-dd
	...
	public static void main(String[] args) {
		System.out.println("getNextMonthDay>>>"+getNextMonthDay("2014-03-28"));
//		Date date=DateUtil.parseDate("2014-02-10");
...
//		begin.set(begin.DATE, begin.getActualMaximum(begin.DATE)); 
//		//得到本月�?���?�� 
//		end.set(end.DATE, end.getActualMaximum(end.DATE)); 
